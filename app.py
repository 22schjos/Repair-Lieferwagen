...
# This loads the Tailwind engine to make the classes (hover, shadows, colors) work
st.markdown("""
        ...
        <section class="bg-white p-8 rounded-2xl shadow-md border border-gray-200 hover:shadow-xl transition-shadow duration-300">
             ...
             <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center group cursor-default">
                    <div class="bg-blue-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 text-[#005293] group-hover:bg-[#005293] group-hover:text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm group-hover:shadow-lg">
                        <div style="transform: scale(1.5);">{ICONS['calendar']}</div>
                    </div>
                    <h4 class="font-bold text-xl mb-3 text-slate-800 group-hover:text-[#005293] transition-colors">1. Fahrplan prüfen</h4>
                    <p class="text-lg text-slate-600">Schauen Sie nach, wann unser Bus in Ihrem Dorf hält.</p>
                </div>
                <div class="text-center group cursor-default">
                    <div class="bg-blue-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 text-[#005293] group-hover:bg-[#005293] group-hover:text-white group-hover:scale-110 group-hover:-rotate-3 transition-all duration-300 shadow-sm group-hover:shadow-lg">
                        <div style="transform: scale(1.5);">{ICONS['map_pin']}</div>
                    </div>
                    <h4 class="font-bold text-xl mb-3 text-slate-800 group-hover:text-[#005293] transition-colors">2. Vorbeikommen</h4>
                    <p class="text-lg text-slate-600">Bringen Sie Ihr defektes Gerät einfach zum Standplatz.</p>
                </div>
                <div class="text-center group cursor-default">
                    <div class="bg-blue-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 text-[#005293] group-hover:bg-[#005293] group-hover:text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm group-hover:shadow-lg">
                        <div style="transform: scale(1.5);">{ICONS['users']}</div>
                    </div>
                    <h4 class="font-bold text-xl mb-3 text-slate-800 group-hover:text-[#005293] transition-colors">3. Reparatur</h4>
                    <p class="text-lg text-slate-600">Während wir reparieren, laden wir Sie ein, uns kennenzulernen.</p>
                </div>
             </div>
        </section>
...
# >>> VIEW: SERVICES <<<
    ...
    <div class="max-w-4xl mx-auto px-4 py-8 md:py-12 space-y-8 animate-in fade-in duration-700">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#005293] hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group cursor-default">
                <div class="flex items-start gap-4">
                    <div class="bg-blue-50 p-3 rounded-lg text-[#005293] shrink-0 group-hover:bg-[#005293] group-hover:text-white transition-colors duration-300">
                        {ICONS['battery']}
                    </div>
                    <div>
                        <h3 class="text-xl font-bold mb-2 text-slate-800 group-hover:text-[#005293] transition-colors">Elektrische Kleingeräte</h3>
                        <p class="text-lg text-slate-600">Wir überprüfen und reparieren Küchengeräte, Föhne, alte Radios, Lampen und mehr.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#005293] hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group cursor-default">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-bold mb-2 text-slate-800 group-hover:text-[#005293] transition-colors">Mechanische Gegenstände</h3>
                        <p class="text-lg text-slate-600">Wackelige Stühle, klemmende Schubladen oder einfaches Spielzeug und mechanische Uhren.</p>
                    </div>
                </div>
            </div>

            <div class="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#005293] md:col-span-2 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group cursor-default">
                <div class="flex items-start gap-4">
                    <div class="bg-blue-50 p-3 rounded-lg text-[#005293] shrink-0 group-hover:bg-[#005293] group-hover:text-white transition-colors duration-300">
                         {ICONS['phone']}
                    </div>
                    <div>
                        <h3 class="text-xl font-bold mb-2 text-slate-800 group-hover:text-[#005293] transition-colors">Hilfe bei Technikfragen</h3>
                        <p class="text-lg text-slate-600">Haben Sie Fragen zur Bedienung eines Geräts? Wir erklären es Ihnen gerne in Ruhe.</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="bg-orange-50 border-l-4 border-[#F2A900] p-6 rounded-r-xl mt-8 hover:bg-orange-100 transition-colors duration-300">
            <h3 class="text-xl font-bold flex items-center gap-3 mb-3 text-[#b45309]">
                <span class="bg-[#F2A900] text-white rounded-full w-8 h-8 flex items-center justify-center font-bold shadow-sm animate-pulse">!</span>
                Wichtiger Hinweis
            </h3>
            <p class="text-lg leading-relaxed text-slate-700">
                Bitte beachten Sie: Großgeräte wie Waschmaschinen können wir im Bus leider nicht reparieren. Auch übernehmen wir keine Garantie wie ein gewerblicher Betrieb.
            </p>
        </div>
...
# >>> VIEW: SCHEDULE <<<
    ...
    # We use a Streamlit button here for the "Action" part
...
# >>> VIEW: ABOUT <<<
    ...
    <div class="max-w-4xl mx-auto px-4 py-8 md:py-12 space-y-8 animate-in fade-in duration-700">
        ...
        <div class="space-y-6 text-lg md:text-xl leading-relaxed text-slate-700">
            <div class="bg-white p-8 rounded-xl shadow-sm border-l-4 border-[#F2A900] hover:shadow-lg hover:translate-x-2 transition-all duration-300">
                <h3 class="font-bold text-2xl mb-3 text-[#005293]">Die Mission</h3>
                <p>Der Repair-Lieferwagen ist mehr als nur eine fahrbare Werkstatt. Er ist ein Projekt unserer Schule, um Brücken zu bauen.</p>
            </div>
            <div class="bg-white p-8 rounded-xl shadow-sm border-l-4 border-[#005293] hover:shadow-lg hover:translate-x-2 transition-all duration-300">
                <h3 class="font-bold text-2xl mb-3 text-[#005293]">Unsere Motivation</h3>
                <p>Für uns junge Menschen ist dies eine wertvolle Gelegenheit. Wir lernen, Verantwortung zu übernehmen.</p>
            </div>
             <div class="bg-white p-8 rounded-xl shadow-sm border-l-4 border-[#005293] hover:shadow-lg hover:translate-x-2 transition-all duration-300">
                <h3 class="font-bold text-2xl mb-3 text-[#005293]">Das Team</h3>
                <p>Wir sind die Schülerinnen und Schüler der Klasse 4Log A der TFO Max Valier.</p>
            </div>
        </div>
...
# >>> VIEW: CONTACT <<<
    ...
    <div class="max-w-4xl mx-auto px-4 py-8 md:py-12 space-y-8 animate-in fade-in duration-700">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                 <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#F2A900] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                    <h3 class="font-bold text-xl mb-2 flex items-center gap-3 text-slate-800">
                        <div class="bg-blue-50 p-2 rounded-full text-[#005293] group-hover:bg-[#F2A900] group-hover:text-white transition-colors duration-300">
                            {ICONS['users']}
                        </div>
                        E-Mail
                    </h3>
                    <a href="mailto:info@repair-lieferwagen.it" class="text-xl text-[#005293] underline decoration-2 underline-offset-4 hover:text-[#003366]">info@repair-lieferwagen.it</a>
                 </div>
                 ...
                 <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#F2A900] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                    ...
                    <p class="not-italic text-lg text-slate-700 leading-relaxed">TFO Max Valier<br>Sorrentostraße 20<br>39100 Bozen</p>
                 </div>
            </div>
        </div>
    </div>
